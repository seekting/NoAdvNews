 ...
 */
public class MyDefaultLoadMoreView extends LinearLayout implements SwipeMenuRecyclerView.LoadMoreView, View.OnClickListener {

    private ProgressBar mLoadingView;
    private TextView mTvMessage;

    public SwipeMenuRecyclerView.LoadMoreListener mLoadMoreListener;

    public MyDefaultLoadMoreView(Context context) {
        this(context, null);
    }

    public MyDefaultLoadMoreView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
